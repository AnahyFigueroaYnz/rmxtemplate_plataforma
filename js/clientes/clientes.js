...
var inicio = {
    activos: function () {
        dataAjax_Proveedores=[
            {
                id_proveedor_c: "a1",
                proveedor: "proveedor1",
                email: "persona1@proveedor1.com",
                contacto: "persona1",
                id_lada: 0,
                telefono: 0,
                direccion: null,
        ...
        $('#agregar_pedido').on('submit', function (form) {
            ...
            if (response == 'false') {
                ...
                if (arreglo_imagenes != 0) {
                    ...
                    resp = true;
                            //Hace el envio de las imagenes de los productos sin proveedor a la bd y servidor
                ...
                if (arreglo_imagenes_prov != 0) {
                    ...
                    resp_prod_prov = true;
                            //Hace el envio de las imagenes de los productos con proveedor a la bd y servidor
                ...
                if (arreglo_invoice != 0) {
                    ...
                    resp_inv = true;
                            //Hace el envio de los archivos de los proveedores a la bd y servidor
                ...
                if (file_Files_oem != 0) {
                    ...
                    resp_oem = true;
                            //Hace el envio de las imagenes del servicio oem a la bd y servidor
