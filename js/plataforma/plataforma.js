...
var plataforma = {
    ...
    get_proveedor: function () {
        $(document).on("click", ".editProveedor", function (event) {
            ...
            var response = cargar_ajax.run_server_ajax('Plataforma/get_datos_proveedor', data);
    ...
    get_datos_producto: function () {
        $(document).on('click', '.edit_producto', function (event) {
            ...
            var response = cargar_ajax.run_server_ajax('Plataforma/ver_datos_editar_producto', data);
    ...
    get_datos_transporte: function () {
        ...
        $(document).on('click', '.edit_puerto', function (event) {
            ...
            var response = cargar_ajax.run_server_ajax('Plataforma/ver_datos_editar_transporte', data);
    ...
    ver_datos_proyecto: function () {
        $(document).on('click', '.asignar_asesor', function (event) {
            ...
            var response = cargar_ajax.run_server_ajax('Plataforma/ver_datos_editar_proyecto', data);
    ...
    editar_proyecto_todos: function () {
        $("#form_editar_proyecto_todo").on("submit", function (e) {
            ...
            if (id_asesor != 0) {
                ...
                var response = cargar_ajax.run_server_ajax('Plataforma/asignar_asesor_proyecto', data);
                ...
                if (status1 != status2) {
                    ...
                    cargar_ajax.run_server_ajax('Plataforma/correo_cambioStatus', data_correo);
                }
                ...
                if (status2 == 24) {
                    ...
                    cargar_ajax.run_server_ajax('Plataforma/finalizar_proyecto', data_fin);
                }
                swal.fire({
                    title: title,
                    text: mensaje,
        ...
        $('#form_detalle_proyecto_asesor').on('submit', function (form) {
            ...
            if (sel != 0) {
                ...
                if (lati != '' && long != '') {
                    ...
                    cargar_ajax.run_server_ajax('Plataforma/update_coordenadas', data_coordenadas);
                }
    ...
    status_cotizacion: function () {
        ...
        $(document).on('click', '.btnAceptar_admin', function (event) {
            ...
            var consulta = cargar_ajax.run_server_ajax('Plataforma/consultaAsesorProyecto', data);
    ...
    editar_perfil: function () {
        ...
        $('#form_editar_perfil').on('submit', function (form) {
            ...
            if (file_Files_perfil != " ") {
                ...
                resp = cargar_ajax2.run_server_ajax2('Plataforma/enviar_img_perfil', frmData_perfil);
    ...
    agentes: function () {
        $('#crear_agente').on('submit', function (form) {
            ...
            var response = cargar_ajax.run_server_ajax('Plataforma/crear_agente', data);
            ...
            if (response == undefined) {
                ...
                var response2 = cargar_ajax.run_server_ajax('Plataforma/insert_relacion', data2);
    ...
    get_pdfCotizacion: function () {
        $(document).on("click", "#btnDescargarCotizacion", function (e) {
            ...
            var get_path = cargar_ajax.run_server_ajax("Plataforma/get_pathCotizacion", data);
            var path = get_path.archivo_path;

            var data_f = { id_proyecto: get_path.id_proyecto };
            var get_folio = cargar_ajax.run_server_ajax("Plataforma/get_folio", data_f);
